            ...
            <form action="#">
              <div class="row">
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <select name="" id="room_types" class="form-control">
                ...
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <select name="" id="bed_types" class="form-control">
                  ...
                  <div class="field-icon-wrap">
                    ...
                    <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <div class="field-icon-wrap">
                        ...
                        <select name="" id="rating" class="form-control">
            ...
            <div class='col-md-6 col-lg-4 mb-5' data-aos='fade-up'>
              <a href='details.php?id=<?php echo $row['id']; ?>' class='room'>
                <figure class='img-wrap'>
                  <img src='images/<?php echo $row['room_image']; ?>' alt='Free website template' class='mb-3' width='500em' height='450em'>
                </figure>
