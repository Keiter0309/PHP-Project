      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            ...
            <img src="images/room3.jpg" alt="Image" class="img-fluid rounded">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/room4.jpg" alt="Free website template" class="mb-3" width='500em' height='350em'>
              </figure>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/room2.jpg" alt="Free website template" class="mb-3" width='500em' height='350em'>
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Family Room</h2>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/room1.jpg" alt="Free website template" class="mb-3" width='500em' height='350em'>
              </figure>
              <div class="p-3 text-center room-info">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/room1.jpg" alt="Image placeholder" class="" width='350em' height='400em'></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/room43.jpg" alt="Image placeholder" class="" width='350em' height='400em'></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="images/room23.jpg" alt="Image placeholder" class="" width='350em' height='400em'></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
